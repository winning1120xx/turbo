...
pub struct FileSystemPath {
    pub fs: Vc<&'static dyn FileSystem>,
    pub path: String,
}
...
impl FileSystemPath {
    ...
    /// in dev mode).
    #[turbo_tasks::function]
    fn new_normalized(fs: Vc<&'static dyn FileSystem>, path: String) -> Vc<Self> {
    ...
    #[turbo_tasks::function]
    pub async fn fs(self: Vc<Self>) -> Result<Vc<&'static dyn FileSystem>> {
        Ok(self.await?.fs)
    }
