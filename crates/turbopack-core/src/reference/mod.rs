...
pub struct AssetReferences(Vec<Vc<&'static dyn AssetReference>>);
...
impl SingleAssetReference {
    ...
    #[turbo_tasks::function]
    pub async fn asset(self: Vc<Self>) -> Result<Vc<&'static dyn Asset>> {
        Ok(self.await?.asset)
    }
}
...
/// [Asset]: crate::asset::Asset
#[turbo_tasks::function]
pub async fn all_referenced_assets(asset: Vc<&'static dyn Asset>) -> Result<Vc<Assets>> {
...
/// [Asset]: crate::asset::Asset
#[turbo_tasks::function]
pub async fn primary_referenced_assets(asset: Vc<&'static dyn Asset>) -> Result<Vc<Assets>> {
    let assets = asset
        .references()
        .await?
        .iter()
...
#[turbo_tasks::function]
pub async fn all_assets(asset: Vc<&'static dyn Asset>) -> Result<Vc<Assets>> {
